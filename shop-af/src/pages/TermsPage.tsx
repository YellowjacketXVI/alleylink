      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-gray-500 mb-8">Last updated: February 5, 2025</p>
            ...
            <div className="prose prose-gray max-w-none space-y-6">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Affiliate Links & Compliance</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Subscriptions & Payments</h2>
                <p className="text-gray-600 leading-relaxed">
