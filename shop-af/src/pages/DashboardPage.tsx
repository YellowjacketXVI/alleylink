            ...
            {!(PLAN_LIMITS[profile.plan_type as keyof typeof PLAN_LIMITS] || PLAN_LIMITS.free).analytics ? (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Get detailed insights about your product performance, click tracking, and more.
                </p>
                <button
                  onClick={handleUpgrade}
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <p className="text-sm text-gray-500">Successful link redirects</p>
                  </div>

                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Active Products</h3>
                    <p className="text-3xl font-bold text-green-600">{products.length}</p>
                    <p className="text-sm text-gray-500">Currently published</p>
                  </div>

                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Profile Views</h3>
                    <p className="text-3xl font-bold text-purple-600">
                      {analyticsLoading ? '...' : analytics.profileViews}
                    </p>
                    <p className="text-sm text-gray-500">Total profile visits</p>
                  </div>
                </div>

                {/* Product Performance */}
                {!analyticsLoading && analytics.productClicks.length > 0 && (
                  <div className="bg-white rounded-lg shadow p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Product Performance</h3>
                    <div className="space-y-3">
                      {analytics.productClicks.slice(0, 5).map((product) => (
